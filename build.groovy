...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - image: registry.default.svc.cluster.local:5000/springboot-demo:latest
...
podTemplate(
        ...
        containers: [
                ...
                envVars: [
                  ...
                  containerEnvVar(key: 'DOCKER_OPTS', value: '--insecure-registry=registry.default.svc.cluster.local:5000')
                ]
                ),
                containerTemplate(
            ...
            timestamps {
                ...
                stage("Build and push springboot webapp image") {
                    container('jenkins-slave-docker') {
                        ...
                        sh "docker build -t registry.default.svc.cluster.local:5000/springboot-demo:${env.BUILD_NUMBER} ."
                        sh "docker push registry.default.svc.cluster.local:5000/springboot-demo:${env.BUILD_NUMBER}"
